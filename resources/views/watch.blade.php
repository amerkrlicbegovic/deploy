      ...
      <div class="row gap-y text-center"> 
        <div class="col-12">          
            ...
            @if($prevLesson->id !== $lesson->id)
              <a href="{{ route('series.watch', ['series' => $series->slug, 'lesson' => $prevLesson->id ]) }}" class="btn btn-info btn-lg pull-left">Prošla Epizoda</a>
            @endif
            @if($nextLesson->id !== $lesson->id)
              <a href="{{ route('series.watch', ['series' => $series->slug, 'lesson' => $nextLesson->id ]) }}" class="btn btn-info btn-lg pull-right">Sljedeća Epizoda</a>
            @endif
