	    ...
	    <div class="modal-dialog" role="document">
	      <div class="modal-content">
	        <div class="modal-header">
	          <h5 class="modal-title" id="exampleModalLabel">Kreiraj novu lekciju</h5>
	        ...
	        <div class="modal-body">
		         <div class="form-group">
	              <input type="text" class="form-control" placeholder="Naslov lekcije" v-model="lesson.title">
	            </div>
	            <div class="form-group">
	              <input type="text" class="form-control" placeholder="Vimeo video id" v-model="lesson.video_id">
	            </div>
	            <div class="form-group">
	              <input type="number" class="form-control" placeholder="Broj lekcije" v-model="lesson.episode_number">
	            </div>
	        ...
	        <div class="modal-footer">
	          ...
	          <button type="button" class="btn btn-primary" @click="updateLesson()" v-if="editing">Spasi lekciju</button>
	          <button type="button" class="btn btn-primary" @click="createLesson()" v-else>Kreiraj lekciju</button>
	        </div>
	      </div>
	    </div>
	  </div>
