        ...
        <div class="card card-shadowed p-50 w-400 mb-0" style="max-width: 100%">
          ...
          <form>
            ...
            <div class="form-group flexbox py-10">
              ...
              <a class="text-muted hover-primary fs-13" href="#">Zaboravio password?</a>
            </div>
          ...
          <p class="text-center text-muted fs-13 mt-20">Nisam registrovan <a href="/register">Kreiraj račun</a></p>
        </div>
      </div>
    </div>
</template>
          ...
          attemptLogin() {
            ...
            axios.post('/login', {
              ...
              if(error.response.status == 422) {
                this.errors.push("Nismo mogli potvrditi vaš računa")
              } else {
